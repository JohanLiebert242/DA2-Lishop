...
const TONE_STYLES = {
  ...
  violet: 'from-violet-500/18 to-purple-500/8 text-violet-700',
  pink: 'from-pink-500/18 to-rose-500/8 text-pink-700',
  cyan: 'from-cyan-500/18 to-blue-500/8 text-cyan-700',
  orange: 'from-orange-500/18 to-amber-500/8 text-orange-700',
  slate: 'from-slate-500/18 to-gray-500/8 text-slate-700',
  purple: 'from-purple-500/18 to-violet-500/8 text-purple-700',
} as const;
